...
let initLoad = ()=>{
    ...
    todoList.innerHTML = `<li><button></button> This is todo to show demo <div>2022-01-07</div> <i class="far fa-trash-alt"></i><p hidden>This is hide</p></li>
    <li><button></button>They'll disappear so don't worry <div></div> <i class="far fa-trash-alt"></i></li>`;
